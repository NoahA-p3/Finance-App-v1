...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-[260px] shrink-0 border-r border-slate-200 bg-white/90 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-950/80 lg:block">
      <div className="p-6">
