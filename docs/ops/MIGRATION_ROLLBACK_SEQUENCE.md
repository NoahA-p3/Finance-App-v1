...
2. `202603290001_company_invitation_acceptance_flow.sql`
3. `202603280001_companies_bootstrap_rls_fix.sql`
4. `202603270003_finance_write_permissions_and_rls_alignment.sql`
5. `202603270002_posting_and_audit_immutability.sql`
6. `202603270001_company_shared_finance_rls.sql`
7. `202603250004_internal_billing_entitlements.sql`
8. `202603250003_active_company_and_company_scoped_finance.sql`
9. `202603250002_company_rbac_baseline.sql`
10. `202603250001_companies_bootstrap.sql`
11. `202603230001_legacy_schema_inventory.sql`
12. `202603210001_profiles_schema_hardening.sql`
13. `202603200004_finance_assistant_mvp.sql` *(legacy artifact; rollback only if part of incident scope)*
14. `202603200003_auth_profile_signup_fields.sql`
15. `202603200002_auth_profiles.sql`
16. `202603200001_init.sql`
...
- `202603290001_company_invitation_acceptance_flow.sql` (invitation acceptance RPC and related policy/control flow).
